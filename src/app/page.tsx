...
export default function Home() {
  ...
  const premiumCars = MOCK_CARS.slice(0, 5);
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 md:px-12 xl:px-16 2xl:px-24 max-w-[1920px] w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 min-[1920px]:grid-cols-5 gap-6 md:gap-8">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 md:px-12 xl:px-16 2xl:px-24 max-w-[1920px] w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 min-[1920px]:grid-cols-5 gap-6 xl:gap-8">
            {premiumCars.map((car) => (
              <CarCard key={car.id} car={car} />
            ))}
          </div>
      ...
      <section className="py-16 md:py-24 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-12 xl:px-16 2xl:px-24 max-w-[1920px] w-full relative z-10">
